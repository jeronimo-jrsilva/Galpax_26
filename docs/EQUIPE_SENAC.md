...
| Integrante | Responsabilidade / Módulo |
| :--- | :--- |
| **Mateus** | Pagamento (Módulo Financeiro) |
| **Lucas** | Banco de Dados (Arquitetura e SQL) |
| **Henrique** | Estacionamento (Controle de Fluxo) |
| **Ramires** | Cadastro (Lojas, Administradores e Veículos) |
| **Arthur** | Banco de Dados (Apoio e Consultas) |
